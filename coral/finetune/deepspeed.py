...
from coral.configs import get_deepspeed_train_config
from coral.datasets import parse_dataset
from coral.finetune.trainer import SupervisedFinetuneTrainer
...
def main() -> None:
    ...
    trainer.train()
    trainer.save(global_steps=trainer.global_step)
