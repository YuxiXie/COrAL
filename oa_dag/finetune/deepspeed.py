...
from oa_dag.configs import get_deepspeed_train_config
from oa_dag.datasets import parse_dataset
from oa_dag.finetune.trainer import SupervisedFinetuneTrainer
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog='deepspeed --module oa_dag.finetune.deepspeed',
